class ComputedFieldsPlugin {
  ...
  constructor () {
    ...
    this.routes = [
      {verb: 'get', url: '/:index/:collection', controller: 'computedFields', action: 'list'},
      {verb: 'post', url: '/:index/:collection', controller: 'computedFields', action: 'create'},
      {verb: 'delete', url: '/:index/:collection/:name', controller: 'computedFields', action: 'delete'},
      {verb: 'patch', url: '/:index/:collection', controller: 'computedFields', action: 'recompute'}
    ];
  }
  ...
  deleteComputedField (request) {
    ...
    let name = request.input.body && request.input.body.name || request.input.args.name
...
module.exports = ComputedFieldsPlugin;
