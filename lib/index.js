...
class CorePlugin {
  ...
  constructor () {
     ...
     *
     * The function "asyncListener" will be called whenever the event is triggered.
     ...
     * @see https://docs.kuzzle.io/kuzzle-events/plugin-events/
     */
    this.hooks = {
  ...
  */
  asyncListener (request) {
    ...
    console.log(`hook action ${request.input.action} on document ${request.result._id}`);
  }
