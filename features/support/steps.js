...
Then('the list contains computed field', function (computedField) {
  ...
  return Promise.reject(
    'Couldn\'t find configured computed field in \'list\' result:\n' + JSON.stringify(this.result)
  );
});
...
Then('the list doesn\'t contain computed field', function (computedField) {
  ...
  return Promise.reject(
    `Computed field with _id = ${this.deletedComputedFieldID} wasn't properly deleted from plugin configuration`
  );
});
